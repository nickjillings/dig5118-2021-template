 ...
 */
//YW: Version3 added Square wave - the cheating approach 
//added sawtooth wave using arcsin approach
//added sinewave function instead of hard code within update audio
//make sure that sinewave function no argument because it uses globle variable
#define FASTADC 1
...
float sawtooth(float sample)
{
  //𝑦[𝑛]=2/𝜋 arcsin⁡(sin⁡(2𝜋𝑓_0 𝑡))

  float value;
  value = (2/PI)*asin(sample);
  return value;
}
